package com.example.faceauthentication.face_recognonize
...
import com.example.faceauthentication.camerax.BaseImageAnalyzer
import com.example.faceauthentication.camerax.GraphicOverlay
import com.example.faceauthentication.model.Person
...
class FaceContourDetectionProcessor(
    ...
    private fun detectEmployee() {
        if (recognisedFaceList.isEmpty() && listOfPerson.isEmpty()) {
            val faseelImage = drawableToBitmap(context, R.drawable.faseel)
            val personListOf =
                arrayListOf(faseelImage)
